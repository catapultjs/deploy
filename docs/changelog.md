...
- The npm package now ships a `catapultjs` agent skill with progressive references (config, recipe, programmatic API) — copy `skills/catapultjs` into `.claude/skills/` to get assisted Catapult work in Claude Code
