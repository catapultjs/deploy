---
description: Drop-in Catapult recipes for Astro, AdonisJS, Caddy, Directus, NestJS, Next.js, Nuxt, PM2, Redis, TanStack, VitePress, git and rsync.
---
...
| [caddy](./caddy)               | Validate, reload, and inspect Caddy                      |
