          ...
          items: [
            ...
            { text: 'Getting Started', link: '/guide/getting-started' },
            {
              ...
              items: [
                ...
                { text: 'config:validate', link: '/guide/cli/config-validate' },
            ...
            { text: 'API Reference', link: '/guide/api' },
            {
              ...
              items: [
                ...
                { text: 'caddy', link: '/guide/recipes/caddy' },
                ...
                { text: 'nestjs', link: '/guide/recipes/nestjs' },
            ...
            { text: 'JSON Configuration', link: '/guide/json-configuration' },
